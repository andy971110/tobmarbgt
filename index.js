...
bot.on('message', function (msg) {	
	...
	MongoClient.connect(dbConfig, function(err, db){
		...
		.toArray(function(err, docs) {
			...
			}else if(msg.text==='\u274c @'+collection.uname2 && collection.uname2!=trans[lang].emp) {
				coll.updateOne({ ChatID: chatId }
					, { $set: { channelN: collection.channelN+1,
			...
			}else if(msg.text==='\u274c @'+collection.uname3 && collection.uname3!=trans[lang].emp) {
			...
			}else if(msg.text==='\u274c @'+collection.uname4 && collection.uname4!=trans[lang].emp) {
				collection.updateOne({ ChatID: chatId }
					, { $set: { channelN: collection.channelN+1,
			...
			}else if(msg.text==='\u274c @'+collection.uname5 && collection.uname5!=trans[lang].emp) {
				collection.updateOne({ ChatID: chatId }
					, { $set: { channelN: collection.channelN+1,
			...
			}else if(msg.text==='\u274c @'+collection.uname6 && collection.uname6!=trans[lang].emp) {
				collection.updateOne({ ChatID: chatId }
					, { $set: { channelN: collection.channelN+1,
			...
			}else if(msg.text==='\u274c @'+collection.uname7 && collection.uname7!=trans[lang].emp) {
				collection.updateOne({ ChatID: chatId }
					, { $set: { channelN: collection.channelN+1,
			...
			}else if(msg.text==='\u274c @'+collection.uname9 && collection.uname9!=trans[lang].emp) {
				collection.updateOne({ ChatID: chatId }
					, { $set: { channelN: collection.channelN+1,
			...
			}else if(msg.text==='\u274c @'+collection.uname10 && collection.uname10!=trans[lang].emp) {
				collection.updateOne({ ChatID: chatId }
					, { $set: { channelN: collection.channelN+1,
